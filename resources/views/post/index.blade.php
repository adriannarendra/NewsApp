...
<head>
    ...
    <style>
        body {
            background-color: #615555; /* Base color */
        }
        ...
        /* Harmonize with orange */
        .text-blue-700,
        .bg-blue-700,
        .dark:bg-blue-600,
        .dark:hover:bg-blue-700,
        .dark:focus:ring-blue-800 {
            color: orange; /* Adjusted color */
        }
        ...
        .dark:focus:ring-yellow-600 {
            background-color: orange; /* Adjusted color */
        }
...
<body>
    <nav class="bg-black border-white dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('img/NewsLogo.png') }}" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">NEWSIFY</span>
            </a>
        </div>
    </nav>
    <div class="container mx-auto p-auto text-center mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            @forelse($post as $p)
            <div class="max-w-sm bg-white rounded-sm shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                ...
                <div class="p-5">
                    ...
                    <a href="{{ route('post.edit', $p->id) }}"
                        ...
                        <svg class="w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h8M2 10V4a2 2 0 0 1 2-2h4l4 4v4a2 2 0 0 1-2 2h-4L2 10Z" />
                        </svg>
                    </a>
                    <form action="{{ route('post.destroy', $p->id) }}" method="POST" class="inline-block mt-2">
                        ...
                        <button type="submit"
                            ...
                            Delete
                            <svg class="w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 2l12 12M2 14l12-12" />
                            </svg>
                        </button>
                    </form>
                </div>
